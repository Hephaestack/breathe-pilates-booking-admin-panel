                    ...
                    <div className="inline-block min-w-full align-middle">
                      <table className="min-w-full divide-y-2 divide-gray-200">
                        <thead className="hidden lg:table-header-group">
                          <tr>
                            <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Τύπος Συνδρομής</th>
                            <th scope="col" className="hidden sm:table-cell px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Έναρξη</th>
                            <th scope="col" className="hidden sm:table-cell px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Λήξη</th>
                            <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Σύνολο Συνεδριών</th>
                            <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Υπόλοιπο</th>
                            <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Κατάσταση Πληρωμής</th>
                          </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                          {subscriptions.map((sub, index) => (
                            <tr key={index} className="flex flex-col transition-colors duration-200 hover:bg-gray-50 lg:table-row">
                              <td className="py-4 pl-4 pr-3 text-sm font-medium text-center text-gray-900 border-b border-gray-200 whitespace-nowrap sm:pl-6 lg:text-left lg:border-b-0 lg:border-r">
                                <div className="mb-1 font-semibold lg:hidden">Τύπος Συνδρομής:</div>
                                {sub.subscription_model}
                              </td>
                              <td className="px-3 py-4 text-sm text-center text-gray-500 border-b border-gray-200 whitespace-nowrap lg:text-left lg:border-b-0 lg:border-r">
                                <div className="mb-1 font-semibold lg:hidden">Έναρξη:</div>
                                {formatDateDMY(sub.start_date)}
                              </td>
                              <td className="px-3 py-4 text-sm text-center text-gray-500 border-b border-gray-200 whitespace-nowrap lg:text-left lg:border-b-0 lg:border-r">
                                <div className="mb-1 font-semibold lg:hidden">Λήξη:</div>
                                {formatDateDMY(sub.end_date)}
                              </td>
                              <td className="px-3 py-4 text-sm text-center text-gray-500 border-b border-gray-200 whitespace-nowrap lg:text-left lg:border-b-0 lg:border-r">
                                <div className="mb-1 font-semibold lg:hidden">Σύνολο:</div>
                                {sub.package_total || '-'}
                              </td>
                              <td className="px-3 py-4 text-sm text-center text-gray-500 border-b border-gray-200 whitespace-nowrap lg:text-left lg:border-b-0 lg:border-r">
                                <div className="mb-1 font-semibold lg:hidden">Υπόλοιπο:</div>
                                {sub.remaining_classes || '-'}
                              </td>
                              <td className="px-3 py-4 text-sm text-center text-gray-500 border-b whitespace-nowrap lg:text-left lg:border-b-0">
                                <div className="mb-1 font-semibold lg:hidden">Κατάσταση Πληρωμής:</div>
                                <div className="flex justify-center lg:justify-start">
                                  <select
                                    className={`w-full max-w-[200px] px-3 py-2 border rounded-lg text-sm font-medium transition-all duration-200 cursor-pointer
                ...
                <div className="overflow-hidden border-2 border-gray-200 rounded-lg shadow-sm">
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y-2 divide-gray-200">
                      <thead className="hidden lg:table-header-group">
                        <tr>
                          <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Μάθημα</th>
                          <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Ημερομηνία</th>
                          <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Ώρα</th>
                          <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Κατάσταση</th>
                        </tr>
                      </thead>
                      <tbody className="bg-white divide-y divide-gray-200">
